  ...
  return (
    <div className="min-h-screen bg-[#050b1e] text-white px-4 md:px-6 py-16">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Title */}
        <h1 className="text-3xl font-bold mb-8">📚 Syllabus List</h1>

        {isLoading ? (
          <p className="text-center text-gray-400">Loading syllabus...</p>
        ) : syllabusData.length === 0 ? (
          <p className="text-center text-gray-400">No syllabus found.</p>
        ) : (
          <>
            {/* ================= MOBILE VIEW ================= */}
