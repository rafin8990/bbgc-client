...
import NocManagement from "../DashboardPages/NocManagement"
...
export const router=createBrowserRouter([
    ...
    //dashboard Layout
    {
        ...
        children:[{index:true, element:<Navigate to="dashboard-manage" replace />},
                 {path:'notice', element:<Notice/>},
                  {path:'slider-management', element:<SliderManagement/>},
                  {path:'chairmen-message', element:<ChairmenMessage/>},
                  ...
                  {path:'at-a-glance', element:<Atglance/>},
                  {path:'syllabus', element:<Syllabus/>},
                  {path:'circular', element:<Circular/>},
                  {path:'admission-result', element:<AdmissionResult/>},
                  {path:'photos', element:<Photos/>},
                  {path:'videos', element:<Videos/>},
                  {path:'dashboard-manage', element:<Dashboardmanage/>},
                  {path:'why-study', element:<Whaystudy/>},
                  {path:'student-list', element:<Studentlist/>},
                  {path:'header-management', element:<HeaderManagement/>},
                  {path:'about-management', element:<AboutManagement/>},
                  {path:'footer-management', element:<FooterManagement/>},
                  {path:'contact-management', element:<ContactManagement/>},
                  {path:'computer-lab-management', element:<ComputerLabManagement/>},
                  {path:'science-lab-management', element:<ScienceLabManagement/>},
                  ...
                  {path:'noc-management', element:<NocManagement/>},
